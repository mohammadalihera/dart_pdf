...
class Context {
  ...
  String get pageLabel =>
      document.catalog.pageLabels == null ? pageNumber.toString() : document.pageLabels.pageLabel(_pageNumber);

  set pageLabel(String value) => document.pageLabels.labels[_pageNumber] = PdfPageLabel(value);
  ...
  Context copyWith({PdfPage? page, PdfGraphics? canvas, Matrix4? ctm, HashMap<Type, Inherited>? inherited}) {
    return Context._(
        document: document, page: page ?? _page, canvas: canvas ?? _canvas, inherited: inherited ?? _inherited);
  }
...
abstract class StatelessWidget extends Widget with SpanningWidget {
  ...
  @override
  bool get canSpan => _child != null && _child is SpanningWidget && (_child as SpanningWidget).canSpan;

  @override
  bool get hasMoreWidgets => _child is SpanningWidget && (_child as SpanningWidget).hasMoreWidgets;
...
abstract class SingleChildWidget extends Widget with SpanningWidget {
  ...
  @override
  bool get canSpan => child is SpanningWidget && (child as SpanningWidget).canSpan;

  @override
  bool get hasMoreWidgets => child is SpanningWidget && (child as SpanningWidget).hasMoreWidgets;

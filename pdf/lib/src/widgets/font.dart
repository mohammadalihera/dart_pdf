...
enum KalpurushFontType { ansi, unicode }
...
class Font {
  ...
  factory Font.courierBoldOblique() => Font.type1(Type1Fonts.courierBoldOblique);
  ...
  factory Font.helveticaBoldOblique() => Font.type1(Type1Fonts.helveticaBoldOblique);
  ...
  static bool isAnsiSupportedText = false;

  static Font? ansi_font;

  static Font? unicode_font;
